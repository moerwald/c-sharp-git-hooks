...
RUN chmod +x /workspace/how-to-use-git-hooks-for-csharp-projects/.githooks/*
RUN chmod +x /workspace/how-to-use-git-hooks-for-csharp-projects/initGitHooks.ps1
RUN chmod +x /workspace/how-to-use-git-hooks-for-csharp-projects/build.ps1
